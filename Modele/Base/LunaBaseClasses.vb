...
Namespace LUNA
	...
	Partial Public Class LunaContext
		...
		Protected Shared Function OpenConn(ConnString As String) As Integer
			...
			Try
				If DbConnection Is Nothing Then DbConnection = New Microsoft.Data.SqlClient.SqlConnection
	...
	Public MustInherit Class LunaBaseClassDAO(Of T)
		...
		Protected _cn As Microsoft.Data.SqlClient.SqlConnection
		...
		Public Sub New()
			...
			End If
			If needNewConn Then
				_ConnectionString = ConfigurationManager.ConnectionStrings("MaConnexion").ConnectionString
				OpenDBConnection()
				_ConnAdHoc = True
			End If
		End Sub
		...
		Protected Function OpenDBConnection() As Integer
			Dim Ris As Integer = 0
			Try
				If _cn Is Nothing Then _cn = New Microsoft.Data.SqlClient.SqlConnection
